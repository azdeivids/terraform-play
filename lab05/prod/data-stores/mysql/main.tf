...
resource "azurerm_mysql_flexible_server" "tfsrv05" {
...
resource "azurerm_mysql_flexible_database" "mysqldb05" {
  name                = "exampledb"
  resource_group_name = azurerm_resource_group.tfrg05.name
  server_name         = azurerm_mysql_flexible_server.tfsrv05.name
  charset             = "utf8"
